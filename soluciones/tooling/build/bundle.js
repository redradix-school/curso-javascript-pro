...
window.onload = function () {
  ...
  var store = new _store2.default(function (action) {
    var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { counter: 0 };
  ...
  var decButton = document.getElementById('dec-button');
